...
<body>
    ...
    <footer>
        <div class="navigation">
            ...
            <div class="links">
                <a href={{ '/' . app()->getLocale() . '/worships' }}>{{ __('worships') }} </a>
        ...
        <div class="medias">
            ...
            <div>
                <a href="/">
                    <svg width="26" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                        <path
                ...
                <a href="/">
                    <svg width="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                        <path
