  ...
  return (
    <GuestLayout>
      ...
      <Form form={form} onSubmit={submit}>
        <Input autoComplete="name" name="name" label={message.auth.register.name} />
        <Input autoComplete="username" type="email" name="email" label={message.auth.email} />
        <PasswordInput autoComplete="new-password" name="password" label={message.auth.password} />
        <PasswordInput
